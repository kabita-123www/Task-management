...
<html>
<head>
	<title>Employee Panel | Task Management System</title>
...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">My Task</a></li>
	...
	<div>
    	...
    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Due Tasks</h2>
